...
if  ($chatTransfer->dep_id > 0) {
	...
	if (!erLhcoreClassChat::hasAccessToRead($chat)){
        ...
        $chat->user_typing_txt = (string)$msg->name_support.' '.htmlspecialchars_decode(erTranslationClassLhTranslation::getInstance()->getTranslation('chat/accepttrasnfer','ingressou ao atendimento!'),ENT_QUOTES);
        $msg->msg = (string)$msg->name_support.' '.erTranslationClassLhTranslation::getInstance()->getTranslation('chat/accepttrasnfer','aceitou a transferência de atendimento!');

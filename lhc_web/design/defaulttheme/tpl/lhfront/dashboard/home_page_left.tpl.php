<div translate="no" ng-class="{hide: rmtoggle}" ng-init="rmtoggle=false" class="col-2 chats-column d-flex border-right pe-0 ps-0"">
<?php /*col chats-column*/ ?>
    <div class="w-100 d-flex flex-column flex-grow-1">
        <div class="clearfix bg-light">
            ...
            <div class="text-muted p-2 float-start"><span class="fs13 fw-bold" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('front/default', 'Chats I have presently opened'); ?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('front/default', 'Atendimentos'); ?></span></div>
            ...
            <!-- <a ng-click="lhc.toggleList('rmtoggle')" class="d-inline-block pt-2 pe-1 float-end text-secondary d-none d-md-block" onclick="$('#tabs a[href=\'#dashboard\']').tab('show')"><i class="material-icons md-18">home</i></a> -->
                ...
                <ul class="nav nav-underline nav-small nav-fill mb-0 pb-0 border-bottom" role="tablist" id="sub-tabs">
                    <li role="presentation" class="nav-item">
                        <a class="nav-link active" href="#sub-tabs-open" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('front/default', 'Open chats'); ?>" aria-controls="sub-tabs-open" role="tab" data-bs-toggle="tab" aria-selected="true">
                            <i class="material-icons chat-active" style="margin-right: 0px;">question_answer</i>
                        </a>
                    </li>

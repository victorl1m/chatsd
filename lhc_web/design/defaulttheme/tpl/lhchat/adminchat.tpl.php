<div class="row">
	...
	<div class="col-xl-8 ps-0 chat-main-left-column" id="chat-main-column-<?php echo $chat->id;?>">
		...
		<div class="message-container-admin" >
            ...
            <?php else : ?>
                <?php $placeholderValue = erTranslationClassLhTranslation::getInstance()->getTranslation('chat/chat','Digite sua mensagem aqui.')?>
            <?php endif;?>

            <div class="d-flex toolbar-chat" translate="no">
                <div class="me-auto">

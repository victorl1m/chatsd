        ...
        <?php elseif ($adminField['fieldtype'] == 'dropdown') : ?>
            ...
            <div class="col-<?php echo htmlspecialchars($adminField['size'])?>">
                <div class="form-floating">
                    <select id="startchat" name="value_items_admin[<?php echo $key?>]" class="form-select<?php if (isset($errors['additional_admin_'.$key])) : ?> is-invalid<?php endif;?>">
                        <option value=""><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Escolher') ?></option>

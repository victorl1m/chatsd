...
<label class="pt-2"><span id="remarks-status-<?php echo $chat->id?>" class="material-icons pb-1 text-success">mode_edit</span> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/adminchat','Notas sobre o atendimento')?></label>
...
<label><span id="remarks-status-online-<?php echo $online_user->id?>" class="material-icons pb-1 text-success">mode_edit</span><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/adminchat','Notas sobre o visitante')?></label>

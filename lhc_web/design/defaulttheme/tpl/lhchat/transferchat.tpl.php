<?php $modalHeaderTitle = erTranslationClassLhTranslation::getInstance()->getTranslation('chat/transferchat','Transferir atendimento')?>
...
<div role="tabpanel">
	<ul class="nav nav-tabs" role="tablist">
        ...
        <?php if (erLhcoreClassUser::instance()->hasAccessTo('lhchat','changeowner')) : ?>
            <li role="presentation" class="nav-item"><a class="nav-link" href="#changeowner" aria-controls="changeowner" role="tab" data-bs-toggle="tab"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/transferchat','Trocar proprietário');?></a></li>
        <?php endif; ?>
	...
	<div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane pt-2" id="changeowner">
            <input class="form-control mb-2 form-control-sm" onkeyup="searchUserTransfer()" id="search-changeowner" type="text" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/lists/search_panel','Procurar analista')?>" />
            ...
            <input type="button" onclick="lhinst.changeOwner('<?php echo $chat->id?>')" class="btn btn-secondary" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/transferchat','Trocar proprietário');?>">
        </div>
        <?php endif; ?>
